...
}`}};function p(){let[e,t]=(0,o.useState)(n[0].value),[a,s]=(0,o.useState)(n[0].value),i=c(e);return(0,r.jsx)("div",{style:{display:"flex",justifyContent:"center",padding:32},children:(0,r.jsxs)("div",{style:{width:280,padding:20,borderRadius:14,background:"rgb(var(--surface))",border:"1px solid rgb(var(--border))",boxShadow:"var(--shadow-card)",display:"flex",flexDirection:"column",gap:14},children:[(0,r.jsx)("p",{style:{fontSize:12,fontWeight:600,letterSpacing:"0.05em",textTransform:"uppercase",color:"rgb(var(--text-tertiary))",margin:0},children:"Brand Colour"}),(0,r.jsx)("div",{style:{display:"grid",gridTemplateColumns:"repeat(6, 1fr)",gap:8},children:n.map(a=>{let i=c(a.value),o=e===a.value;return(0,r.jsx)("button",{title:a.label,onClick:()=>{var e;t(e=a.value),s(e)},style:{width:36,height:36,borderRadius:8,background:a.value,border:o?`2px solid ${i}`:"2px solid transparent",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",boxShadow:o?"inset 0 1px 0 rgba(255,255,255,0.3), 0 0 0 2px rgba(0,0,0,0.1)":"inset 0 1px 0 rgba(255,255,255,0.18)",transition:"transform 0.15s, box-shadow 0.15s",transform:o?"scale(1.12)":"scale(1)"},children:o&&(0,r.jsx)(l.Check,{size:14,color:i,strokeWidth:3})},a.value)})}),(0,r.jsx)("input",{type:"text",value:a,onChange:function(e){let r=e.target.value;s(r),/^#[0-9A-Fa-f]{6}$/.test(r)&&t(r)},placeholder:"#FF6B35",style:{padding:"8px 12px",borderRadius:8,border:"1px solid rgb(var(--border))",background:"rgb(var(--surface-raised))",color:"rgb(var(--text-primary))",fontSize:13,fontFamily:"monospace",outline:"none"}}),(0,r.jsx)("div",{style:{height:44,borderRadius:10,background:e,display:"flex",alignItems:"center",justifyContent:"center",fontSize:12,fontWeight:600,fontFamily:"monospace",color:i,boxShadow:"inset 0 1px 0 rgba(255,255,255,0.2), 0 2px 6px rgba(0,0,0,0.15)",letterSpacing:"0.04em",transition:"background 0.2s"},children:e}),(0,r.jsxs)("div",{style:{padding:"10px 14px",borderRadius:8,border:"1px solid rgb(var(--border))",background:"rgb(var(--surface-raised))",display:"flex",alignItems:"center",gap:10},children:[(0,r.jsx)("div",{style:{width:10,height:10,borderRadius:"50%",background:e,flexShrink:0}}),(0,r.jsx)("span",{style:{fontSize:13,flex:1},children:"Button preview"}),(0,r.jsx)("button",{style:{padding:"5px 12px",borderRadius:6,background:e,color:i,fontSize:12,fontWeight:600,border:"none",cursor:"pointer"},children:"Action"})]})]})})}e.s(["default",0,function(){return(0,r.jsxs)("div",{children:[(0,r.jsx)(t.PageHeader,{title:"Color Picker",description:"Allows users to select a brand or theme colour from a curated palette or a custom hex value. Includes the accessibleForeground algorithm to ensure legible text on any chosen colour.",badge:"New"}),(0,r.jsxs)("section",{children:[(0,r.jsx)("h2",{children:"Demo"}),(0,r.jsx)("p",{children:"Select a swatch or type a hex value. The preview button updates in real time, demonstrating how the chosen colour renders with automatically-computed foreground text."}),(0,r.jsx)(a.ComponentPreview,{children:(0,r.jsx)(p,{})})]}),(0,r.jsxs)("section",{children:[(0,r.jsx)("h2",{children:"Accessible foreground algorithm"}),(0,r.jsx)("p",{children:"The picker always computes a legible foreground (black or white) for the selected colour using the WCAG relative luminance formula. This ensures button labels and preview text are always readable regardless of brand colour choice."}),(0,r.jsx)("pre",{children:(0,r.jsx)("code",{children:`// WCAG 2.1 relative luminance → choose black or white
...
}`})}),(0,r.jsxs)("p",{children:["This is the web equivalent of Warren's ",(0,r.jsx)("code",{children:"accessibleForeground(on:)"})," Swift function. Use it whenever rendering text or icons on a user-chosen colour."]})]}),(0,r.jsxs)("section",{children:[(0,r.jsx)("h2",{children:"Dynamic brand token"}),(0,r.jsxs)("p",{children:["When the user selects a colour, write it to the ",(0,r.jsx)("code",{children:"--brand-user"})," CSS variable on the document root. Other tokens resolve through it automatically:"]}),(0,r.jsx)("pre",{children:(0,r.jsx)("code",{children:`// Apply user-chosen brand colour globally
...
}`})})]}),(0,r.jsxs)("section",{children:[(0,r.jsx)("h2",{children:"Implementation"}),(0,r.jsx)(i.PlatformTabs,{code:u})]}),(0,r.jsx)(s.PropsTable,{props:d})]})}])}]);