...
}`}};e.s(["default",0,function(){let[e,d]=(0,i.useState)("idle"),[c,p]=(0,i.useState)(!1),[g,u]=(0,i.useState)("import"),[b,x]=(0,i.useState)("csv"),[m,f]=(0,i.useState)(new Set(["name","company","status","date","salary"]));function v(){d("uploading"),setTimeout(()=>{d("processing"),setTimeout(()=>d("results"),1500)},1e3)}return(0,r.jsxs)("div",{children:[(0,r.jsx)(t.PageHeader,{title:"Import / Export",description:"A data import flow with a glass-surfaced drop zone, progress states, and results summary — plus a structured export flow with format and field selection.",badge:"New"}),(0,r.jsxs)("section",{children:[(0,r.jsx)("h2",{children:"Demo"}),(0,r.jsx)(a.ComponentPreview,{children:(0,r.jsxs)("div",{style:{padding:24,maxWidth:480,margin:"0 auto"},children:[(0,r.jsx)("div",{style:{display:"flex",gap:2,marginBottom:20,padding:3,borderRadius:8,background:"rgb(var(--surface-raised))",border:"1px solid rgb(var(--border))",width:"fit-content"},children:["import","export"].map(e=>(0,r.jsx)("button",{onClick:()=>u(e),style:{padding:"5px 16px",borderRadius:6,fontSize:13,fontWeight:500,border:"none",cursor:"pointer",background:g===e?"rgb(var(--accent))":"transparent",color:g===e?"#fff":"rgb(var(--text-secondary))",textTransform:"capitalize",transition:"all 0.15s"},children:e},e))}),"import"===g&&(0,r.jsxs)(r.Fragment,{children:["idle"===e&&(0,r.jsxs)("div",{onDragOver:e=>{e.preventDefault(),p(!0)},onDragLeave:()=>p(!1),onDrop:e=>{e.preventDefault(),p(!1),v()},onClick:v,style:{border:`2px dashed ${c?"rgb(var(--accent))":"rgb(var(--border))"}`,borderRadius:12,padding:"40px 24px",textAlign:"center",cursor:"pointer",background:c?"rgb(var(--accent) / 0.06)":"rgb(var(--surface))",backdropFilter:c?"blur(8px) saturate(160%)":"none",boxShadow:c?"inset 0 1px 0 rgba(255,255,255,0.08)":"none",transition:"background 0.15s, border-color 0.15s"},children:[(0,r.jsx)(o.Upload,{size:32,style:{margin:"0 auto 12px",display:"block",color:c?"rgb(var(--accent))":"rgb(var(--text-tertiary))"}}),(0,r.jsx)("p",{style:{fontWeight:600,marginBottom:6},children:c?"Drop to import":"Drop file here or click to browse"}),(0,r.jsx)("p",{style:{fontSize:13,color:"rgb(var(--text-tertiary))"},children:"Supports CSV and JSON — up to 50 MB"})]}),("uploading"===e||"processing"===e)&&(0,r.jsxs)("div",{style:{textAlign:"center",padding:"40px 24px"},children:[(0,r.jsx)("p",{style:{fontWeight:600,marginBottom:16},children:"uploading"===e?"Uploading…":"Processing rows…"}),(0,r.jsx)("div",{style:{height:6,borderRadius:99,background:"rgb(var(--progress-track))",overflow:"hidden"},children:(0,r.jsx)("div",{style:{height:"100%",width:"uploading"===e?"40%":"85%",borderRadius:99,background:"rgb(var(--accent))",transition:"width 1s ease-in-out"}})})]}),"results"===e&&(0,r.jsxs)("div",{style:{display:"flex",flexDirection:"column",gap:14},children:[(0,r.jsx)("div",{style:{display:"grid",gridTemplateColumns:"repeat(3, 1fr)",gap:10},children:[{label:"Imported",value:142,c:"var(--status-success)"},{label:"Skipped",value:3,c:"var(--status-warning)"},{label:"Errors",value:3,c:"var(--status-danger)"}].map(e=>(0,r.jsxs)("div",{style:{padding:12,borderRadius:8,background:"rgb(var(--surface))",border:"1px solid rgb(var(--border))",textAlign:"center"},children:[(0,r.jsx)("div",{style:{fontSize:22,fontWeight:700,color:`rgb(${e.c})`,fontVariantNumeric:"tabular-nums"},children:e.value}),(0,r.jsx)("div",{style:{fontSize:11,color:"rgb(var(--text-tertiary))",marginTop:2},children:e.label})]},e.label))}),(0,r.jsxs)("div",{style:{borderRadius:8,border:"1px solid rgb(var(--border))",overflow:"hidden"},children:[(0,r.jsx)("div",{style:{padding:"7px 12px",background:"rgb(var(--surface-raised))",borderBottom:"1px solid rgb(var(--border))",fontSize:11,fontWeight:600,color:"rgb(var(--text-tertiary))"},children:"Errors (3)"}),[{row:17,reason:"Missing required field: company"},{row:45,reason:"Invalid date format"},{row:98,reason:"Duplicate entry"}].map(e=>(0,r.jsxs)("div",{style:{display:"flex",gap:12,alignItems:"center",padding:"8px 12px",borderBottom:"1px solid rgb(var(--border-subtle))",fontSize:12},children:[(0,r.jsxs)("span",{style:{color:"rgb(var(--text-tertiary))",fontVariantNumeric:"tabular-nums",flexShrink:0,width:48},children:["Row ",e.row]}),(0,r.jsx)("span",{style:{color:"rgb(var(--status-danger))"},children:e.reason})]},e.row))]}),(0,r.jsx)("button",{onClick:()=>d("idle"),style:{alignSelf:"flex-start",padding:"7px 14px",borderRadius:8,border:"1px solid rgb(var(--border))",background:"rgb(var(--surface-raised))",cursor:"pointer",fontSize:13},children:"Import another file"})]})]}),"export"===g&&(0,r.jsxs)("div",{style:{display:"flex",flexDirection:"column",gap:16},children:[(0,r.jsxs)("div",{children:[(0,r.jsx)("p",{style:{fontSize:12,fontWeight:600,marginBottom:8},children:"Format"}),(0,r.jsx)("div",{style:{display:"flex",gap:8},children:["csv","json"].map(e=>(0,r.jsx)("button",{onClick:()=>x(e),style:{padding:"7px 16px",borderRadius:8,fontSize:13,cursor:"pointer",background:b===e?"rgb(var(--accent))":"rgb(var(--surface-raised))",color:b===e?"#fff":"rgb(var(--text-primary))",border:`1px solid ${b===e?"rgb(var(--accent))":"rgb(var(--border))"}`,fontWeight:b===e?600:400,transition:"all 0.15s"},children:e.toUpperCase()},e))})]}),(0,r.jsxs)("div",{children:[(0,r.jsx)("p",{style:{fontSize:12,fontWeight:600,marginBottom:8},children:"Fields to include"}),(0,r.jsx)("div",{style:{display:"flex",flexDirection:"column",gap:6},children:["name","company","status","date","salary","notes","tags"].map(e=>(0,r.jsxs)("label",{style:{display:"flex",alignItems:"center",gap:8,cursor:"pointer"},children:[(0,r.jsx)("input",{type:"checkbox",checked:m.has(e),onChange:()=>{f(r=>{let t=new Set(r);return t.has(e)?t.delete(e):t.add(e),t})},style:{width:15,height:15,accentColor:"rgb(var(--accent))"}}),(0,r.jsx)("span",{style:{fontSize:13,textTransform:"capitalize"},children:e})]},e))})]}),(0,r.jsxs)("button",{style:{display:"flex",alignItems:"center",gap:8,padding:"9px 18px",borderRadius:8,background:"rgb(var(--accent))",color:"#fff",border:"none",cursor:"pointer",fontSize:14,fontWeight:600,alignSelf:"flex-start"},children:[(0,r.jsx)(l.Download,{size:15}),"Export ",m.size," fields as ",b.toUpperCase()]})]})]})})]}),(0,r.jsxs)("section",{children:[(0,r.jsx)("h2",{children:"Import flow states"}),(0,r.jsxs)("table",{children:[(0,r.jsx)("thead",{children:(0,r.jsxs)("tr",{children:[(0,r.jsx)("th",{children:"Phase"}),(0,r.jsx)("th",{children:"UI"})]})}),(0,r.jsxs)("tbody",{children:[(0,r.jsxs)("tr",{children:[(0,r.jsx)("td",{children:"Idle"}),(0,r.jsx)("td",{children:"Drop zone with dashed border, upload icon, format hint"})]}),(0,r.jsxs)("tr",{children:[(0,r.jsx)("td",{children:"Drag over"}),(0,r.jsxs)("td",{children:["Glass surface activates: ",(0,r.jsx)("code",{children:"backdrop-filter"}),", accent border, specular top edge"]})]}),(0,r.jsxs)("tr",{children:[(0,r.jsx)("td",{children:"Uploading"}),(0,r.jsx)("td",{children:'Progress bar at ~40%, "Uploading…" label'})]}),(0,r.jsxs)("tr",{children:[(0,r.jsx)("td",{children:"Processing"}),(0,r.jsx)("td",{children:'Progress bar at ~85%, "Processing rows…" label'})]}),(0,r.jsxs)("tr",{children:[(0,r.jsx)("td",{children:"Results"}),(0,r.jsx)("td",{children:"3-tile summary (imported / skipped / errors) + scrollable error table"})]})]})]})]}),(0,r.jsxs)("section",{children:[(0,r.jsx)("h2",{children:"Drop zone glass behaviour"}),(0,r.jsxs)("p",{children:["The drop zone uses ",(0,r.jsx)("code",{children:"backdrop-filter: blur(8px) saturate(160%)"})," and a specular inset highlight (",(0,r.jsx)("code",{children:"inset 0 1px 0 rgba(255,255,255,0.08)"}),") when a file is dragged over it. This is the same Liquid Glass treatment used on the Feature Gate overlay and the Context Menu — the brightening mimics ",(0,r.jsx)("code",{children:"sfBrandLitSurface"}),"."]}),(0,r.jsxs)("p",{children:["Apply ",(0,r.jsx)("code",{children:"@media (prefers-reduced-transparency)"})," fallback: replace the backdrop filter with a solid accent-tinted background."]})]}),(0,r.jsxs)("section",{children:[(0,r.jsx)("h2",{children:"Implementation"}),(0,r.jsx)(s.PlatformTabs,{code:n})]})]})}])}]);