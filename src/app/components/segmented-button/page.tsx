...
import { ViewToggleDemo, IconOnlyDemo, MultiSelectDemo, SizesDemo } from "@/site/docs/SegmentedButtonDemo";
import { SegmentedButtonMobileDemo } from "@/site/docs/ComponentMobileDemos";
